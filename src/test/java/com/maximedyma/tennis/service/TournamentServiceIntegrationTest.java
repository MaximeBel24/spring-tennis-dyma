...
public class TournamentServiceIntegrationTest {
    ...
    public void shouldUpdateTournament() {
        // Given
        UUID frenchOpenIdentifier = UUID.fromString("a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12");
    ...
    public void shouldDeleteTournament() {
        // Given
        UUID tournamentToDelete = UUID.fromString("a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14");
